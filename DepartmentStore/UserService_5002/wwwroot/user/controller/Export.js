...
function RenderExportTable(productId, time) {
    $.ajax({
        url: `/Product_Branch/GetListByFilter`,
        type: 'POST',
...
function UploadExportProductByExcel() {
    ...
    $.ajax({
        url: '/Product_Branch/UploadExportProductByExcel',
        type: 'POST',
        data: formData,
...
function ExportSampleProductFileExcel() {
    window.location.href = '/Product_Branch/ExportSampleProductFileExcel';
}
...
function UpdateExport(id) {
    ...
    $.ajax({
        url: '/Product_Branch/UpdateExport',
        type: 'PUT',
        data: formData,
        processData: false, 
        contentType: false, 
